...
! function(t, e) {
    ...
    if (!r.TweenLite) {
                ...
                this.check = function(u) {
                    ...
                    if (0 === y && o) {
                        if (c = ("com.greensock." + n).split("."), p = c.pop(), d = h(c.join("."))[p] = this.gsClass = o.apply(o, l), a)
                            if (r[p] = i[p] = d, g = "undefined" != typeof module && module.exports, !g && "function" == typeof define && define.amd) define((t.GreenSockAMDPath ? t.GreenSockAMDPath + "/" : "") + n.split(".").pop(), [], function() {
                                return d
                            });
                            else if (g)
                            if (n === e) {
        ...
        for (o = x.prototype, o._calcEnd = !1, o.getRatio = function(t) {
            ...
            }, n = ["Linear", "Quad", "Cubic", "Quart", "Quint,Strong"], s = n.length; --s > -1;) o = n[s] + ",Power" + s, T(new x(null, null, 1, s), o, "easeOut", !0), T(new x(null, null, 2, s), o, "easeIn" + (0 === s ? ",easeNone" : "")), T(new x(null, null, 3, s), o, "easeInOut");
        w.linear = u.easing.Linear.easeIn, w.swing = u.easing.Quad.easeInOut;
        var b = v("events.EventDispatcher", function(t) {
            this._listeners = {}, this._eventTarget = t || this
        });
        o = b.prototype, o.addEventListener = function(t, e, i, r, n) {
            n = n || 0;
        ...
        v("Ticker", function(t, e) {
            var i, r, n, s, o, h = this,
                ...
                g = function(t) {
                    var e, a, l = O() - k;
                    l > d && (u += l - _), k += l, h.time = (k - u) / 1e3, e = h.time - o, (!i || e > 0 || t === !0) && (h.frame++, o += e + (e >= s ? .004 : s - e), a = !0), t !== !0 && (n = r(g)), a && h.dispatchEvent(m)
                };
            b.call(h), h.time = h.frame = 0, h.tick = function() {
                ...
                null !== n ? h.sleep() : t ? u += -k + (k = O()) : h.frame > 10 && (k = O() - d + 5), r = 0 === i ? p : c && P ? P : function(t) {
        ...
        a = C.ticker = new u.Ticker, o = C.prototype, o._dirty = o._gc = o._initted = o._paused = !1, o._totalTime = o._time = 0, o._rawPrevTime = -1, o._next = o._last = o._onUpdate = o._timeline = o.timeline = null, o._paused = !1;
        var A = function() {
        ...
        o = R.prototype = new C, o.constructor = R, o.kill()._gc = !1, o._first = o._last = o._recent = null, o._sortChildren = !1, o.add = o.insert = function(t, e, i, r) {
            var n, s;
        ...
        var M = v("TweenLite", function(e, i, r) {
                ...
                if (this._overwrite = l = null == l ? U[M.defaultOverwrite] : "number" == typeof l ? l >> 0 : U[l], (a || e instanceof Array || e.push && d(e)) && "number" != typeof e[0])
                    for (this._targets = o = c(e), this._propLookup = [], this._siblings = [], n = 0; n < o.length; n++) s = o[n], s ? "string" != typeof s ? s.length && s !== t && s[0] && (s[0] === t || s[0].nodeType && s[0].style && !s.nodeType) ? (o.splice(n--, 1), this._targets = o = o.concat(c(s))) : (this._siblings[n] = H(s, this, !1), 1 === l && this._siblings[n].length > 1 && $(s, this, null, 1, this._siblings[n])) : (s = o[n--] = M.selector(s), "string" == typeof s && o.splice(n + 1, 1)) : o.splice(n--, 1);
        ...
        o = M.prototype = new C, o.constructor = M, o.kill()._gc = !1, o.ratio = 0, o._firstPT = o._targets = o._overwrittenProps = o._startAt = null, o._notifyPluginsOfEnabled = o._lazy = !1, M.version = "1.19.0", M.defaultEase = o._ease = new x(null, null, 1, 1), M.defaultOverwrite = "auto", M.ticker = a, M.autoSleep = 120, M.lagSmoothing = function(t, e) {
            a.lagSmoothing(t, e)
        ...
        var z = [],
            ...
            E = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
            X = function(t) {
                for (var e, i = this._firstPT, r = 1e-6; i;) e = i.blob ? t ? this.join("") : this.start : i.c * t + i.s, i.m ? e = i.m(e, this._target || i.t) : r > e && e > -r && (e = 0), i.f ? i.fp ? i.t[i.p](i.fp, e) : i.t[i.p](e) : i.t[i.p] = e, i = i._next
            },
            N = function(t, e, i, r) {
                var n, s, o, a, l, h, u, f = [t, e],
                    c = 0,
                    p = "",
                    d = 0;
                for (f.start = t, i && (i(f), t = f[0], e = f[1]), f.length = 0, n = t.match(E) || [], s = e.match(E) || [], r && (r._next = null, r.blob = 1, f._firstPT = f._applyPT = r), l = s.length, a = 0; l > a; a++) u = s[a], h = e.substr(c, e.indexOf(u, c) - c), p += h || !a ? h : ",", c += h.length, d ? d = (d + 1) % 5 : "rgba(" === h.substr(-5) && (d = 1), u === n[a] || n.length <= a ? p += u : (p && (f.push(p), p = ""), o = parseFloat(n[a]), f.push(o), f._firstPT = {
                    _next: f._firstPT,
                    t: f,
                    p: f.length - 1,
                    s: o,
            ...
            Y = function(t, e, i, r, n, s, o, a, l) {
                ...
                return "number" !== c && ("function" === c && "get" === i && (u = e.indexOf("set") || "function" != typeof t["get" + e.substr(3)] ? e : "get" + e.substr(3), d.s = f = o ? t[u](o) : t[u]()), "string" == typeof f && (o || isNaN(f)) ? (d.fp = o, h = N(f, r, a || M.defaultStringFilter, d), d = {
                    t: h,
                    p: "setRatio",
                    s: 0,
                    c: 1,
                    ...
                    pr: 0,
                    m: 0
                }) : p || (d.s = parseFloat(f), d.c = parseFloat(r) - d.s || 0)), d.c ? ((d._next = this._firstPT) && (d._next._prev = d), this._firstPT = d, d) : void 0
            },
            j = M._internals = {
                isArray: d,
                isSelector: F,
        ...
        G._startTime = a.time, W._startTime = a.frame, G._active = W._active = !0, setTimeout(Z, 1), C._updateRoot = M.render = function() {
            var t, e, i;
        ...
        var H = function(t, e, i) {
            ...
            $ = function(t, e, i, r, n) {
                ...
                var h, u = e._startTime + f,
                    ...
                    p = 0,
                    d = 0 === e._duration;
                for (s = n.length; --s > -1;)(a = n[s]) === e || a._gc || a._paused || (a._timeline !== e._timeline ? (h = h || J(e, 0, d), 0 === J(a, h, d) && (c[p++] = a)) : a._startTime <= u && a._startTime + a.totalDuration() / a._timeScale > u && ((d || !a._initted) && u - a._startTime <= 2e-10 || (c[p++] = a)));
                for (s = p; --s > -1;)
        ...
        o._init = function() {
            ...
            if (this._ease = u = u ? u instanceof x ? u : "function" == typeof u ? new x(u, o.easeParams) : w[u] || M.defaultEase : M.defaultEase, o.easeParams instanceof Array && u.config && (this._ease = u.config.apply(u, o.easeParams)), this._easeType = this._ease._type, this._easePower = this._ease._power, this._firstPT = null, this._targets)
            ...
            return n && this._kill(n, e) ? this._initProps(e, i, r, n, s) : this._overwrite > 1 && this._firstPT && r.length > 1 && $(e, this, i, this._overwrite, r) ? (this._kill(i, e), this._initProps(e, i, r, n, s)) : (this._firstPT && (this.vars.lazy !== !1 && this._duration || this.vars.lazy && !this._duration) && (D[e._gsTweenID] = !0), l)
        }, o.render = function(t, e, i) {
            var r, n, s, o, a = this._time,
                l = this._duration,
                h = this._rawPrevTime;
            if (t >= l - 1e-7) this._totalTime = this._time = l, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1, this._reversed || (r = !0, n = "onComplete", i = i || this._timeline.autoRemoveChildren), 0 === l && (this._initted || !this.vars.lazy || i) && (this._startTime === this._timeline._duration && (t = 0), (0 > h || 0 >= t && t >= -1e-7 || h === f && "isPause" !== this.data) && h !== t && (i = !0, h > f && (n = "onReverseComplete")), this._rawPrevTime = o = !e || t || h === t ? t : f);
            else if (1e-7 > t) this._totalTime = this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== a || 0 === l && h > 0) && (n = "onReverseComplete", r = this._reversed), 0 > t && (this._active = !1, 0 === l && (this._initted || !this.vars.lazy || i) && (h >= 0 && (h !== f || "isPause" !== this.data) && (i = !0), this._rawPrevTime = o = !e || t || h === t ? t : f)), this._initted || (i = !0);
            ...
            if (this._time !== a || i) {
                ...
                this._onUpdate && (0 > t && this._startAt && t !== -1e-4 && this._startAt.render(t, e, i), e || (this._time !== a || r || i) && this._callback("onUpdate")), n && (!this._gc || i) && (0 > t && this._startAt && !this._onUpdate && t !== -1e-4 && this._startAt.render(t, e, i), r && (this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !e && this.vars[n] && this._callback(n), 0 === l && this._rawPrevTime === f && o !== f && (this._rawPrevTime = 0))
            }
            ...
            if ((d(e) || F(e)) && "number" != typeof e[0])
                ...
                if (a) {
                    ...
                    for (s in h)(o = a[s]) && (c && (o.f ? o.t[o.p](o.s) : o.t[o.p] = o.s, l = !0), o.pg && o.t._kill(h) && (l = !0), o.pg && 0 !== o.t._overwriteProps.length || (o._prev ? o._prev._next = o._next : o === this._firstPT && (this._firstPT = o._next), o._next && (o._next._prev = o._prev), o._next = o._prev = null), delete a[s]), u && (n[s] = 1);
        ...
        if (o = tt.prototype, tt.version = "1.19.0", tt.API = 2, o._firstPT = null, o._addTween = Y, o.setRatio = X, o._kill = function(t) {
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(t, e, i) {
            var r = function(t) {
                ...
                m = r.prototype = new e;
            return r.version = "1.19.0", m.constructor = r, m.kill()._gc = m._forcingPlayhead = m._hasPause = !1, m.to = function(t, e, r, n) {
                ...
                var f, d, m = new r({
                    ...
                    g = n.cycle;
                for ("string" == typeof t && (t = i.selector(t) || t), t = t || [], a(t) && (t = _(t)), s = s || 0, 0 > s && (t = _(t), t.reverse(), s *= -1), d = 0; d < t.length; d++) f = c(n), f.startAt && (f.startAt = c(f.startAt), f.startAt.cycle && p(f.startAt, t, d)), g && (p(f, t, d), null != f.duration && (e = f.duration, delete f.duration)), m.to(t[d], e, f, d * s);
                return this.add(m, o)
                ...
                if ("number" != typeof s && (s = this._parseTimeOrLabel(s, 0, !0, n)), !(n instanceof t)) {
                    if (n instanceof Array || n && n.push && l(n)) {
                        for (o = o || "normal", a = a || 0, h = s, u = n.length, f = 0; u > f; f++) l(c = n[f]) && (c = new r({
                            tweens: c
                ...
                var r, s, o, a, l, f, c, p = this._dirty ? this.totalDuration() : this._totalDuration,
                    d = this._time,
                    _ = this._startTime,
                    m = this._timeScale,
                    g = this._paused;
                if (t >= p - 1e-7) this._totalTime = this._time = p, this._reversed || this._hasPausedChild() || (s = !0, a = "onComplete", l = !!this._timeline.autoRemoveChildren, 0 === this._duration && (0 >= t && t >= -1e-7 || this._rawPrevTime < 0 || this._rawPrevTime === n) && this._rawPrevTime !== t && this._first && (l = !0, this._rawPrevTime > n && (a = "onReverseComplete"))), this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : n, t = p + 1e-4;
                else if (1e-7 > t)
                    if (this._totalTime = this._time = 0, (0 !== d || 0 === this._duration && this._rawPrevTime !== n && (this._rawPrevTime > 0 || 0 > t && this._rawPrevTime >= 0)) && (a = "onReverseComplete", s = this._reversed), 0 > t) this._active = !1, this._timeline.autoRemoveChildren && this._reversed ? (l = s = !0, a = "onReverseComplete") : this._rawPrevTime >= 0 && this._first && (l = !0), this._rawPrevTime = t;
                    else {
                ...
                if (this._time !== d && this._first || i || l || f) {
                    if (this._initted || (this._initted = !0), this._active || !this._paused && this._time !== d && t > 0 && (this._active = !0), 0 === d && this.vars.onStart && (0 === this._time && this._duration || e || this._callback("onStart")), c = this._time, c >= d)
                        for (r = this._first; r && (o = r._next, c === this._time && (!this._paused || g));)(r._active || r._startTime <= c && !r._paused && !r._gc) && (f === r && this.pause(), r._reversed ? r.render((r._dirty ? r.totalDuration() : r._totalDuration) - (t - r._startTime) * r._timeScale, e, i) : r.render((t - r._startTime) * r._timeScale, e, i)), r = o;
                    else
                    ...
                    this._onUpdate && (e || (h.length && u(), this._callback("onUpdate"))), a && (this._gc || (_ === this._startTime || m !== this._timeScale) && (0 === this._time || p >= this.totalDuration()) && (s && (h.length && u(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !e && this.vars[a] && this._callback(a)))
                }
                ...
                n = n || -9999999999;
                for (var s = [], o = this._first, a = 0; o;) o._startTime < n || (o instanceof i ? e !== !1 && (s[a++] = o) : (r !== !1 && (s[a++] = o), t !== !1 && (s = s.concat(o.getChildren(!0, e, r)), a = s.length))), o = o._next;
                return s
            }, m.getTweensOf = function(t, e) {
                var r, n, s = this._gc,
                    o = [],
        ...
        _gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(t, e) {
            ...
            var u, f, c, p, d, _, m, g, v = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
                ...
                U = function() {
                    var t = V.indexOf("Android"),
                        e = j("a");
                    return c = -1 !== V.indexOf("Safari") && -1 === V.indexOf("Chrome") && (-1 === t || Number(V.substr(t + 8, 1)) > 3), d = c && Number(V.substr(V.indexOf("Version/") + 8, 1)) < 6, p = -1 !== V.indexOf("Firefox"), (/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(V) || /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(V)) && (_ = parseFloat(RegExp.$1)), e ? (e.style.cssText = "top:1px;opacity:.55;", /^0.55/.test(e.style.opacity)) : !1
                }(),
                W = function(t) {
                ...
                $ = o.getStyle = function(t, e, i, r, n) {
                    var s;
                    return U || "opacity" !== e ? (!r && t.style[e] ? s = t.style[e] : (i = i || K(t)) ? s = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(k, "-$1").toLowerCase()) : t.currentStyle && (s = t.currentStyle[e]), null == n || s && "none" !== s && "auto" !== s && "auto auto" !== s ? s : n) : W(t)
                },
                J = q.convertToPixels = function(t, i, r, n, s) {
                    ...
                    if (p && (r = -r), d && (r *= 100), "%" === n && -1 !== i.indexOf("border")) a = r / 100 * (u ? t.clientWidth : t.clientHeight);
                        ...
                        f.appendChild(I), a = parseFloat(I[u ? "offsetWidth" : "offsetHeight"]), f.removeChild(I), u && "%" === n && o.cacheWidths !== !1 && (l = f._gsCache = f._gsCache || {}, l.time = h, l.width = a / r * 100), 0 !== a || s || (a = J(t, i, r, n, !0))
                    }
                ...
                et = function(t, e) {
                    ...
                    if (e = e || K(t, null))
                        if (i = e.length)
                            for (; --i > -1;) n = e[i], (-1 === n.indexOf("-transform") || Ct === n) && (s[n.replace(C, R)] = e.getPropertyValue(n));
                        else
                            for (i in e)(-1 === i.indexOf("Transform") || kt === i) && (s[i] = e[i]);
                    else if (e = t.currentStyle || t.style)
                        for (i in e) "string" == typeof i && void 0 === s[i] && (s[i.replace(C, R)] = e[i]);
                    return U || (s.opacity = W(t)), r = It(t, e, !1), s.rotation = r.rotation, s.skewX = r.skewX, s.scaleX = r.scaleX, s.scaleY = r.scaleY, s.x = r.x, s.y = r.y, Rt && (s.z = r.z, s.rotationX = r.rotationX, s.rotationY = r.rotationY, s.scaleZ = r.scaleZ), s.filters && delete s.filters, s
                },
                it = function(t, e, i, r, n) {
                    var s, o, a, l = {},
                        h = t.style;
                    for (o in i) "cssText" !== o && "length" !== o && isNaN(o) && (e[o] !== (s = i[o]) || n && n[o]) && -1 === o.indexOf("Origin") && ("number" == typeof s || "string" == typeof s) && (l[o] = "auto" !== s || "left" !== o && "top" !== o ? "" !== s && "auto" !== s && "none" !== s || "string" != typeof e[o] || "" === e[o].replace(w, "") ? s : 0 : tt(t, o), void 0 !== h[o] && (a = new gt(h, o, h[o], a)));
                    if (r)
                ...
                ht = function(t, e, i, r) {
                    ...
                    return "function" == typeof t && (t = t(g, m)), null == t ? a = e : "number" == typeof t ? a = t : (n = 360, s = t.split("_"), l = "=" === t.charAt(1), o = (l ? parseInt(t.charAt(0) + "1", 10) * parseFloat(s[0].substr(2)) : parseFloat(s[0])) * (-1 === t.indexOf("rad") ? 1 : X) - (l ? 0 : e), s.length && (r && (r[i] = e + o), -1 !== t.indexOf("short") && (o %= n, o !== o % (n / 2) && (o = 0 > o ? o + n : o - n)), -1 !== t.indexOf("_cw") && 0 > o ? o = (o + 9999999999 * n) % n - (o / n | 0) * n : -1 !== t.indexOf("ccw") && o > 0 && (o = (o - 9999999999 * n) % n - (o / n | 0) * n)), a = e + o), h > a && a > -h && (a = 0), a
                },
                ut = {
                    aqua: [0, 255, 255],
                    lime: [0, 255, 0],
                    ...
                    if (t)
                        if ("number" == typeof t) i = [t >> 16, t >> 8 & 255, 255 & t];
                            ...
                            if ("," === t.charAt(t.length - 1) && (t = t.substr(0, t.length - 1)), ut[t]) i = ut[t];
                                ...
                                } else o = Number(i[0]) % 360 / 360, a = Number(i[1]) / 100, l = Number(i[2]) / 100, n = .5 >= l ? l * (a + 1) : l + a - l * a, r = 2 * l - n, i.length > 3 && (i[3] = Number(t[3])), i[0] = ft(o + 1 / 3, r, n), i[1] = ft(o, r, n), i[2] = ft(o - 1 / 3, r, n);
                            else i = t.match(v) || ut.transparent;
                            i[0] = Number(i[0]), i[1] = Number(i[1]), i[2] = Number(i[2]), i.length > 3 && (i[3] = Number(i[3]))
                        }
                    else i = ut.black;
                    return e && !c && (r = i[0] / 255, n = i[1] / 255, s = i[2] / 255, h = Math.max(r, n, s), u = Math.min(r, n, s), l = (h + u) / 2, h === u ? o = a = 0 : (f = h - u, a = l > .5 ? f / (2 - h - u) : f / (h + u), o = h === r ? (n - s) / f + (s > n ? 6 : 0) : h === n ? (s - r) / f + 2 : (r - n) / f + 4, o *= 60), i[0] = o + .5 | 0, i[1] = 100 * a + .5 | 0, i[2] = 100 * l + .5 | 0), i
                },
                pt = function(t, e) {
            ...
            var _t = function(t, e, i, r) {
                    ...
                    return u ? n = e ? function(t) {
                        ...
                        if (e = (t.match(dt) || [s])[0], c = t.split(e).join("").match(x) || [], p = c.length, u > p--)
                ...
                vt = (q._parseToProxy = function(t, e, i, r, n, s) {
                    ...
                    this.t = t, this.p = e, this.s = r, this.c = n, this.n = l || e, t instanceof vt || s.push(this.n), this.r = h, this.type = a || 0, u && (this.pr = u, i = !0), this.b = void 0 === f ? r : f, this.e = void 0 === c ? r + n : c, o && (this._next = o, o._prev = this)
                }),
            ...
            h.xs0 = "", h._next = h._prev = h.xfirst = h.data = h.plugin = h.setRatio = h.rxp = null, h.appendXtra = function(t, e, i, r, n, s) {
                var o = this,
                    a = o.l;
                return o["xs" + a] += s && (a || o["xs" + a]) ? " " + t : t || "", i || 0 === a || o.plugin ? (o.l++, o.type = o.setRatio ? 2 : 1, o["xs" + o.l] = r || "", a > 0 ? (o.data["xn" + a] = e + i, o.rxp["xn" + a] = n, o["xn" + a] = e, o.plugin || (o.xfirst = new vt(o, "xn" + a, e, i, o.xfirst || o, 0, o.n, n, o.pr), o.xfirst.xs0 = 0), o) : (o.data = {
                    s: e + i
                }, o.rxp = {}, o.s = e, o.c = i, o.r = n, o)) : (o["xs" + a] += e + (r || ""), o)
            };
            var Tt = function(t, e) {
                    e = e || {}, this.p = e.prefix ? H(t) || t : t, l[t] = l[this.p] = this, this.format = e.formatter || _t(e.defaultValue, e.color, e.collapsible, e.multi), e.parser && (this.parse = e.parser), this.clrs = e.color, this.multi = e.multi, this.keyword = e.keyword, this.dflt = e.defaultValue, this.pr = e.priority || 0
                },
            ...
            h = Tt.prototype, h.parseComplex = function(t, e, i, r, n, s) {
                var o, a, l, h, u, f, c = this.keyword;
                if (this.multi && (z.test(i) || z.test(e) ? (a = e.replace(z, "|").split("|"), l = i.replace(z, "|").split("|")) : c && (a = [e], l = [i])), l) {
                    for (h = l.length > a.length ? l.length : a.length, o = 0; h > o; o++) e = a[o] = a[o] || this.dflt, i = l[o] = l[o] || this.dflt, c && (u = e.indexOf(c), f = i.indexOf(c), u !== f && (-1 === f ? a[o] = a[o].split(c).join("") : -1 === u && (a[o] += " " + c)));
                    e = a.join(", "), i = l.join(", ")
                }
            ...
            var St, Ot = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                kt = H("transform"),
                Ct = Q + "transform",
                ...
                Lt = function(t, e, i) {
                    var r, n = Y.createElementNS("http://www.w3.org/2000/svg", t),
                        s = /([a-z])([A-Z])/g;
                ...
                Dt = function() {
                    ...
                    return Y.createElementNS && !r && (t = Lt("svg", zt), e = Lt("rect", t, {
                        width: 100,
                        height: 50,
                        x: 100
                    }), i = e.getBoundingClientRect().width, e.style[At] = "50% 50%", e.style[kt] = "scaleX(0.5)", r = i === e.getBoundingClientRect().width && !(p && Rt), zt.removeChild(t)), r
                }(),
                Et = function(t, e, i, r, n, s) {
                    var a, l, h, u, f, c, p, d, _, m, g, v, y, x, w = t._gsTransform,
                        T = jt(t, !0);
                    w && (y = w.xOrigin, x = w.yOrigin), (!r || (a = r.split(" ")).length < 2) && (p = t.getBBox(), e = ot(e).split(" "), a = [(-1 !== e[0].indexOf("%") ? parseFloat(e[0]) / 100 * p.width : parseFloat(e[0])) + p.x, (-1 !== e[1].indexOf("%") ? parseFloat(e[1]) / 100 * p.height : parseFloat(e[1])) + p.y]), i.xOrigin = u = parseFloat(a[0]), i.yOrigin = f = parseFloat(a[1]), r && T !== Yt && (c = T[0], p = T[1], d = T[2], _ = T[3], m = T[4], g = T[5], v = c * _ - p * d, l = u * (_ / v) + f * (-d / v) + (d * g - _ * m) / v, h = u * (-p / v) + f * (c / v) - (c * g - p * m) / v, u = i.xOrigin = a[0] = l, f = i.yOrigin = a[1] = h), w && (s && (i.xOffset = w.xOffset, i.yOffset = w.yOffset, w = i), n || n !== !1 && o.defaultSmoothOrigin !== !1 ? (l = u - y, h = f - x, w.xOffset += l * T[0] + h * T[2] - l, w.yOffset += l * T[1] + h * T[3] - h) : w.xOffset = w.yOffset = 0), s || t.setAttribute("data-svg-origin", a.join(" "))
                },
                Xt = function(t) {
                    try {
                        return t.getBBox()
                ...
                Yt = [1, 0, 0, 1, 0, 0],
                jt = function(t, e) {
                    var i, r, n, s, o, a, l = t._gsTransform || new Mt,
                        h = 1e5,
                        u = t.style;
                    if (kt ? r = $(t, Ct, null, !0) : t.currentStyle && (r = t.currentStyle.filter.match(F), r = r && 4 === r.length ? [r[0].substr(4), Number(r[2].substr(4)), Number(r[1].substr(4)), r[3].substr(4), l.x || 0, l.y || 0].join(",") : ""), i = !r || "none" === r || "matrix(1, 0, 0, 1, 0, 0)" === r, i && kt && ((a = "none" === K(t).display) || !t.parentNode) && (a && (s = u.display, u.display = "block"), t.parentNode || (o = 1, zt.appendChild(t)), r = $(t, Ct, null, !0), i = !r || "none" === r || "matrix(1, 0, 0, 1, 0, 0)" === r, s ? u.display = s : a && Vt(u, "display"), o && zt.removeChild(t)), (l.svg || t.getBBox && Nt(t)) && (i && -1 !== (u[kt] + "").indexOf("matrix") && (r = u[kt], i = 0), n = t.getAttribute("transform"), i && n && (-1 !== n.indexOf("matrix") ? (r = n, i = 0) : -1 !== n.indexOf("translate") && (r = "matrix(1,0,0,1," + n.match(/(?:\-|\b)[\d\-\.e]+\b/gi).join(",") + ")", i = 0))), i) return Yt;
                    for (n = (r || "").match(v) || [], wt = n.length; --wt > -1;) s = Number(n[wt]), n[wt] = (o = s - (s |= 0)) ? (o * h + (0 > o ? -.5 : .5) | 0) / h + s : s;
                    return e && n.length > 6 ? [n[0], n[1], n[4], n[5], n[12], n[13]] : n
                },
                It = q.getTransform = function(t, i, r, n) {
                    if (t._gsTransform && r && !n) return t._gsTransform;
                    var s, a, l, h, u, f, c = r ? t._gsTransform || new Mt : new Mt,
                        p = c.scaleX < 0,
                        d = 2e-5,
                        _ = 1e5,
                    ...
                    if (c.svg = !(!t.getBBox || !Nt(t)), c.svg && (Et(t, $(t, At, i, !1, "50% 50%") + "", c, t.getAttribute("data-svg-origin")), St = o.useSVGTransformAttr || Dt), s = jt(t), s !== Yt) {
                        if (16 === s.length) {
                            var v, y, x, w, T, b = s[0],
                                ...
                                N = s[11],
                                Y = Math.atan2(A, L);
                            c.zOrigin && (E = -c.zOrigin, z = M * E - s[12], D = F * E - s[13], E = L * E + c.zOrigin - s[14]), c.rotationX = Y * X, Y && (w = Math.cos(-Y), T = Math.sin(-Y), v = k * w + M * T, y = C * w + F * T, x = A * w + L * T, M = k * -T + M * w, F = C * -T + F * w, L = A * -T + L * w, N = R * -T + N * w, k = v, C = y, A = x), Y = Math.atan2(-S, L), c.rotationY = Y * X, Y && (w = Math.cos(-Y), T = Math.sin(-Y), v = b * w - M * T, y = P * w - F * T, x = S * w - L * T, F = P * T + F * w, L = S * T + L * w, N = O * T + N * w, b = v, P = y, S = x), Y = Math.atan2(P, b), c.rotation = Y * X, Y && (w = Math.cos(-Y), T = Math.sin(-Y), b = b * w + k * T, y = P * w + C * T, C = P * -T + C * w, A = S * -T + A * w, P = y), c.rotationX && Math.abs(c.rotationX) + Math.abs(c.rotation) > 359.9 && (c.rotationX = c.rotation = 0, c.rotationY = 180 - c.rotationY), c.scaleX = (Math.sqrt(b * b + P * P) * _ + .5 | 0) / _, c.scaleY = (Math.sqrt(C * C + F * F) * _ + .5 | 0) / _, c.scaleZ = (Math.sqrt(A * A + L * L) * _ + .5 | 0) / _, c.rotationX || c.rotationY ? c.skewX = 0 : (c.skewX = k || C ? Math.atan2(k, C) * X + c.rotation : c.skewX || 0, Math.abs(c.skewX) > 90 && Math.abs(c.skewX) < 270 && (p ? (c.scaleX *= -1, c.skewX += c.rotation <= 0 ? 180 : -180, c.rotation += c.rotation <= 0 ? 180 : -180) : (c.scaleY *= -1, c.skewX += c.skewX <= 0 ? 180 : -180))), c.perspective = N ? 1 / (0 > N ? -N : N) : 0, c.x = z, c.y = D, c.z = E, c.svg && (c.x -= c.xOrigin - (c.xOrigin * b - c.yOrigin * k), c.y -= c.yOrigin - (c.yOrigin * P - c.xOrigin * C))
                            ...
                            var j = s.length >= 6,
                                ...
                                q = s[2] || 0,
                                V = j ? s[3] : 1;
                            c.x = s[4] || 0, c.y = s[5] || 0, l = Math.sqrt(I * I + B * B), h = Math.sqrt(V * V + q * q), u = I || B ? Math.atan2(B, I) * X : c.rotation || 0, f = q || V ? Math.atan2(q, V) * X + u : c.skewX || 0, Math.abs(f) > 90 && Math.abs(f) < 270 && (p ? (l *= -1, f += 0 >= u ? 180 : -180, u += 0 >= u ? 180 : -180) : (h *= -1, f += 0 >= f ? 180 : -180)), c.scaleX = l, c.scaleY = h, c.rotation = u, c.skewX = f, Rt && (c.rotationX = c.rotationY = c.z = 0, c.perspective = g, c.scaleZ = 1), c.svg && (c.x -= c.xOrigin - (c.xOrigin * I + c.yOrigin * q), c.y -= c.yOrigin - (c.xOrigin * B + c.yOrigin * V))
                        }
                        c.zOrigin = m;
                        for (a in c) c[a] < d && c[a] > -d && (c[a] = 0)
                    }
                    return r && (t._gsTransform = c, c.svg && (St && t.style[kt] ? e.delayedCall(.001, function() {
                        Vt(t.style, kt)
                ...
                $t = function(t) {
                    ...
                    if (c) {
                        ...
                        if (null != r.ox && (p = (r.oxp ? m * r.ox * .01 : r.ox) - m / 2, d = (r.oyp ? g * r.oy * .01 : r.oy) - g / 2, x += p - (p * a + d * l), w += d - (p * h + d * u)), v ? (p = m / 2, d = g / 2, y += ", Dx=" + (p - (p * a + d * l) + x) + ", Dy=" + (d - (p * h + d * u) + w) + ")") : y += ", sizingMethod='auto expand')", -1 !== e.indexOf("DXImageTransform.Microsoft.Matrix(") ? f.filter = e.replace(L, y) : f.filter = y + " " + e, (0 === t || 1 === t) && 1 === a && 0 === l && 0 === h && 1 === u && (v && -1 === y.indexOf("Dx=0, Dy=0") || b.test(e) && 100 !== parseFloat(RegExp.$1) || -1 === e.indexOf(e.indexOf("Alpha")) && f.removeAttribute("filter")), !v) {
                            var P, S, O, k = 8 > _ ? 1 : -1;
                            for (p = r.ieOffsetX || 0, d = r.ieOffsetY || 0, r.ieOffsetX = Math.round((m - ((0 > a ? -a : a) * m + (0 > l ? -l : l) * g)) / 2 + x), r.ieOffsetY = Math.round((g - ((0 > u ? -u : u) * g + (0 > h ? -h : h) * m)) / 2 + w), wt = 0; 4 > wt; wt++) S = nt[wt], P = c[S], i = -1 !== P.indexOf("px") ? parseFloat(P) : J(this.t, S, parseFloat(P), P.replace(T, "")) || 0, O = i !== r[S] ? 2 > wt ? -r.ieOffsetX : -r.ieOffsetY : 2 > wt ? p - r.ieOffsetX : d - r.ieOffsetY, f[S] = (r[S] = Math.round(i - O * (0 === wt || 2 === wt ? 1 : k))) + "px"
                        }
                    }
                },
                Bt = q.set3DTransformRatio = q.setTransformRatio = function(t) {
                    var e, i, r, n, s, o, a, l, h, u, f, c, d, _, m, g, v, y, x, w, T, b, P, S = this.data,
                        O = this.t.style,
                        k = S.rotation,
                        C = S.rotationX,
                        A = S.rotationY,
                        ...
                        N = S.perspective,
                        Y = S.force3D;
                    if (((1 === t || 0 === t) && "auto" === Y && (this.tween._totalTime === this.tween._totalDuration || !this.tween._totalTime) || !Y) && !D && !N && !A && !C && 1 === F || St && X || !Rt) return void(k || S.skewX || X ? (k *= E, b = S.skewX * E, P = 1e5, e = Math.cos(k) * R, n = Math.sin(k) * R, i = Math.sin(k - b) * -M, s = Math.cos(k - b) * M, b && "simple" === S.skewType && (v = Math.tan(b - S.skewY * E), v = Math.sqrt(1 + v * v), i *= v, s *= v, S.skewY && (v = Math.tan(S.skewY * E), v = Math.sqrt(1 + v * v), e *= v, n *= v)), X && (L += S.xOrigin - (S.xOrigin * e + S.yOrigin * i) + S.xOffset, z += S.yOrigin - (S.xOrigin * n + S.yOrigin * s) + S.yOffset, St && (S.xPercent || S.yPercent) && (_ = this.t.getBBox(), L += .01 * S.xPercent * _.width, z += .01 * S.yPercent * _.height), _ = 1e-6, _ > L && L > -_ && (L = 0), _ > z && z > -_ && (z = 0)), x = (e * P | 0) / P + "," + (n * P | 0) / P + "," + (i * P | 0) / P + "," + (s * P | 0) / P + "," + L + "," + z + ")", X && St ? this.t.setAttribute("transform", "matrix(" + x) : O[kt] = (S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) matrix(" : "matrix(") + x) : O[kt] = (S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) matrix(" : "matrix(") + R + ",0,0," + M + "," + L + "," + z + ")");
                    if (p && (_ = 1e-4, _ > R && R > -_ && (R = F = 2e-5), _ > M && M > -_ && (M = F = 2e-5), !N || S.z || S.rotationX || S.rotationY || (N = 0)), k || S.skewX) k *= E, m = e = Math.cos(k), g = n = Math.sin(k), S.skewX && (k -= S.skewX * E, m = Math.cos(k), g = Math.sin(k), "simple" === S.skewType && (v = Math.tan((S.skewX - S.skewY) * E), v = Math.sqrt(1 + v * v), m *= v, g *= v, S.skewY && (v = Math.tan(S.skewY * E), v = Math.sqrt(1 + v * v), e *= v, n *= v))), i = -g, s = m;
                    else {
                        if (!(A || C || 1 !== F || N || X)) return void(O[kt] = (S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) translate3d(" : "translate3d(") + L + "px," + z + "px," + D + "px)" + (1 !== R || 1 !== M ? " scale(" + R + "," + M + ")" : ""));
                        e = s = 1, i = n = 0
                    }
                    h = 1, r = o = a = l = u = f = 0, c = N ? -1 / N : 0, d = S.zOrigin, _ = 1e-6, w = ",", T = "0", k = A * E, k && (m = Math.cos(k), g = Math.sin(k), a = -g, u = c * -g, r = e * g, o = n * g, h = m, c *= m, e *= m, n *= m), k = C * E, k && (m = Math.cos(k), g = Math.sin(k), v = i * m + r * g, y = s * m + o * g, l = h * g, f = c * g, r = i * -g + r * m, o = s * -g + o * m, h *= m, c *= m, i = v, s = y), 1 !== F && (r *= F, o *= F, h *= F, c *= F), 1 !== M && (i *= M, s *= M, l *= M, f *= M), 1 !== R && (e *= R, n *= R, a *= R, u *= R), (d || X) && (d && (L += r * -d, z += o * -d, D += h * -d + d), X && (L += S.xOrigin - (S.xOrigin * e + S.yOrigin * i) + S.xOffset, z += S.yOrigin - (S.xOrigin * n + S.yOrigin * s) + S.yOffset), _ > L && L > -_ && (L = T), _ > z && z > -_ && (z = T), _ > D && D > -_ && (D = 0)), x = S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) matrix3d(" : "matrix3d(", x += (_ > e && e > -_ ? T : e) + w + (_ > n && n > -_ ? T : n) + w + (_ > a && a > -_ ? T : a), x += w + (_ > u && u > -_ ? T : u) + w + (_ > i && i > -_ ? T : i) + w + (_ > s && s > -_ ? T : s), C || A || 1 !== F ? (x += w + (_ > l && l > -_ ? T : l) + w + (_ > f && f > -_ ? T : f) + w + (_ > r && r > -_ ? T : r), x += w + (_ > o && o > -_ ? T : o) + w + (_ > h && h > -_ ? T : h) + w + (_ > c && c > -_ ? T : c) + w) : x += ",0,0,0,0,1,0,", x += L + w + z + w + D + w + (N ? 1 + -D / N : 1) + ")", O[kt] = x
                };
            h = Mt.prototype, h.x = h.y = h.z = h.skewX = h.skewY = h.rotation = h.rotationX = h.rotationY = h.zOrigin = h.xPercent = h.yPercent = h.xOffset = h.yOffset = 0, h.scaleX = h.scaleY = h.scaleZ = 1, bt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
                parser: function(t, e, i, r, s, a, l) {
                    if (r._lastParsedTransform === l) return s;
                    r._lastParsedTransform = l;
                    var h;
                    "function" == typeof l[i] && (h = l[i], l[i] = e);
                    var u, f, c, p, d, _, v, y, x, w = t._gsTransform,
                        T = t.style,
                        b = 1e-6,
                        P = Ot.length,
                        S = l,
                    ...
                    if (r._transform = C, A && "string" == typeof A && kt) f = I.style, f[kt] = A, f.display = "block", f.position = "absolute", Y.body.appendChild(I), u = It(I, null, !1), C.svg && (_ = C.xOrigin, v = C.yOrigin, u.x -= C.xOffset, u.y -= C.yOffset, (S.transformOrigin || S.svgOrigin) && (A = {}, Et(t, ot(S.transformOrigin), A, S.svgOrigin, S.smoothOrigin, !0), _ = A.xOrigin, v = A.yOrigin, u.x -= A.xOffset - C.xOffset, u.y -= A.yOffset - C.yOffset), (_ || v) && (y = jt(I, !0), u.x -= _ - (_ * y[0] + v * y[2]), u.y -= v - (_ * y[1] + v * y[3]))), Y.body.removeChild(I), u.perspective || (u.perspective = C.perspective), null != S.xPercent && (u.xPercent = lt(S.xPercent, C.xPercent)), null != S.yPercent && (u.yPercent = lt(S.yPercent, C.yPercent));
                        ...
                        "string" == typeof S.x && -1 !== S.x.indexOf("%") && (u.x = 0, u.xPercent = lt(S.x, C.xPercent)), "string" == typeof S.y && -1 !== S.y.indexOf("%") && (u.y = 0, u.yPercent = lt(S.y, C.yPercent)), u.rotation = ht("rotation" in S ? S.rotation : "shortRotation" in S ? S.shortRotation + "_short" : "rotationZ" in S ? S.rotationZ : C.rotation - C.skewY, C.rotation - C.skewY, "rotation", O), Rt && (u.rotationX = ht("rotationX" in S ? S.rotationX : "shortRotationX" in S ? S.shortRotationX + "_short" : C.rotationX || 0, C.rotationX, "rotationX", O), u.rotationY = ht("rotationY" in S ? S.rotationY : "shortRotationY" in S ? S.shortRotationY + "_short" : C.rotationY || 0, C.rotationY, "rotationY", O)), u.skewX = ht(S.skewX, C.skewX - C.skewY), (u.skewY = ht(S.skewY, C.skewY)) && (u.skewX += u.skewY, u.rotation += u.skewY)
                    }
                    for (Rt && null != S.force3D && (C.force3D = S.force3D, p = !0), C.skewType = S.skewType || C.skewType || o.defaultSkewType, c = C.force3D || C.z || C.rotationX || C.rotationY || u.z || u.rotationX || u.rotationY || u.perspective, c || null == S.scale || (u.scaleZ = 1); --P > -1;) x = Ot[P], A = u[x] - C[x], (A > b || -b > A || null != S[x] || null != N[x]) && (p = !0, s = new vt(C, x, C[x], A, s), x in O && (s.e = O[x]), s.xs0 = 0, s.plugin = a, r._overwriteProps.push(s.n));
                    return A = S.transformOrigin, C.svg && (A || S.svgOrigin) && (_ = C.xOffset, v = C.yOffset, Et(t, ot(A), u, S.svgOrigin, S.smoothOrigin), s = yt(C, "xOrigin", (w ? C : u).xOrigin, u.xOrigin, s, k), s = yt(C, "yOrigin", (w ? C : u).yOrigin, u.yOrigin, s, k), (_ !== C.xOffset || v !== C.yOffset) && (s = yt(C, "xOffset", w ? _ : C.xOffset, C.xOffset, s, k), s = yt(C, "yOffset", w ? v : C.yOffset, C.yOffset, s, k)), A = St ? null : "0px 0px"), (A || Rt && c && C.zOrigin) && (kt ? (p = !0, x = At, A = (A || $(t, x, n, !1, "50% 50%")) + "", s = new vt(T, x, 0, 0, s, -1, k), s.b = T[x], s.plugin = a, Rt ? (f = C.zOrigin, A = A.split(" "), C.zOrigin = (A.length > 2 && (0 === f || "0px" !== A[2]) ? parseFloat(A[2]) : f) || 0, s.xs0 = s.e = A[0] + " " + (A[1] || "50%") + " 0px", s = new vt(C, "zOrigin", 0, 0, s, -1, s.n), s.b = f, s.xs0 = s.e = C.zOrigin) : s.xs0 = s.e = A) : ot(A + "", C)), p && (r._transformType = C.svg && St || !c && 3 !== this._transformType ? 2 : 3), h && (l[i] = h), s
                },
                prefix: !0
            }), bt("boxShadow", {
                ...
                parser: function(t, e, i, s, o, a) {
                    e = this.format(e);
                    var l, h, u, f, c, p, d, _, m, g, v, y, x, w, T, b, P = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomRightRadius", "borderBottomLeftRadius"],
                        S = t.style;
                    for (m = parseFloat(t.offsetWidth), g = parseFloat(t.offsetHeight), l = e.split(" "), h = 0; h < P.length; h++) this.p.indexOf("border") && (P[h] = H(P[h])), c = f = $(t, P[h], n, !1, "0px"), -1 !== c.indexOf(" ") && (f = c.split(" "), c = f[0], f = f[1]), p = u = l[h], d = parseFloat(c), y = c.substr((d + "").length), x = "=" === p.charAt(1), x ? (_ = parseInt(p.charAt(0) + "1", 10), p = p.substr(2), _ *= parseFloat(p), v = p.substr((_ + "").length - (0 > _ ? 1 : 0)) || "") : (_ = parseFloat(p), v = p.substr((_ + "").length)), "" === v && (v = r[i] || y), v !== y && (w = J(t, "borderLeft", d, y), T = J(t, "borderTop", d, y), "%" === v ? (c = w / m * 100 + "%", f = T / g * 100 + "%") : "em" === v ? (b = J(t, "borderLeft", 1, "em"), c = w / b + "em", f = T / b + "em") : (c = w + "px", f = T + "px"), x && (p = parseFloat(c) + _ + v, u = parseFloat(f) + _ + v)), o = xt(S, P[h], c + " " + f, p + " " + u, !1, "0px", o);
                    return o
                },
                prefix: !0,
                ...
                defaultValue: "0 0",
                parser: function(t, e, i, r, s, o) {
                    var a, l, h, u, f, c, p = "background-position",
                        d = n || K(t, null),
                    ...
                    if (-1 !== m.indexOf("%") != (-1 !== g.indexOf("%")) && g.split(",").length < 2 && (c = $(t, "backgroundImage").replace(A, ""), c && "none" !== c)) {
                        for (a = m.split(" "), l = g.split(" "), B.setAttribute("src", c), h = 2; --h > -1;) m = a[h], u = -1 !== m.indexOf("%"), u !== (-1 !== l[h].indexOf("%")) && (f = 0 === h ? t.offsetWidth - B.width : t.offsetHeight - B.height, a[h] = u ? parseFloat(m) / 100 * f + "px" : parseFloat(m) / f * 100 + "%");
                        m = a.join(" ")
                    }
                ...
                parser: function(t, e, i, r, s, o) {
                    var a, l, h;
                    return 9 > _ ? (l = t.currentStyle, h = 8 > _ ? " " : ",", a = "rect(" + l.clipTop + h + l.clipRight + h + l.clipBottom + h + l.clipLeft + ")", e = this.format(e).split(",").join(h)) : (a = this.format($(t, this.p, n, !1, this.dflt)), e = this.format(e)), this.parseComplex(t.style, a, e, s, o)
                }
            }), bt("textShadow", {
                ...
                parser: function(t, e, i, r, s, o) {
                    var a = $(t, "borderTopWidth", n, !1, "0px"),
                        ...
                        h = l[0].replace(T, "");
                    return "px" !== h && (a = parseFloat(a) / J(t, "borderTopWidth", 1, h) + h), this.parseComplex(t.style, this.format(a + " " + $(t, "borderTopStyle", n, !1, "solid") + " " + $(t, "borderTopColor", n, !1, "#000")), l.join(" "), s, o)
                },
                color: !0,
                formatter: function(t) {
                    var e = t.split(" ");
            ...
            var qt = function(t) {
                var e, i = this.t,
                    ...
                    n = this.s + this.c * t | 0;
                100 === n && (-1 === r.indexOf("atrix(") && -1 === r.indexOf("radient(") && -1 === r.indexOf("oader(") ? (i.removeAttribute("filter"), e = !$(this.data, "filter")) : (i.filter = r.replace(S, ""), e = !0)), e || (this.xn1 && (i.filter = r = r || "alpha(opacity=" + n + ")"), -1 === r.indexOf("pacity") ? 0 === n && this.xn1 || (i.filter = r + " alpha(opacity=" + n + ")") : i.filter = r.replace(b, "opacity=" + n))
            };
            bt("opacity,alpha,autoAlpha", {
                ...
                parser: function(t, e, i, r, s, o) {
                    var a = parseFloat($(t, "opacity", n, !1, "1")),
                        l = t.style,
                        h = "autoAlpha" === i;
                    return "string" == typeof e && "=" === e.charAt(1) && (e = ("-" === e.charAt(0) ? -1 : 1) * parseFloat(e.substr(2)) + a), h && 1 === a && "hidden" === $(t, "visibility", n) && 0 !== e && (a = 0), U ? s = new vt(l, "opacity", a, e - a, s) : (s = new vt(l, "opacity", 100 * a, 100 * (e - a), s), s.xn1 = h ? 1 : 0, l.zoom = 1, s.type = 2, s.b = "alpha(opacity=" + s.s + ")", s.e = "alpha(opacity=" + (s.s + s.c) + ")", s.data = t, s.plugin = o, s.setRatio = qt), h && (s = new vt(l, "visibility", 0, 0, s, -1, null, !1, 0, 0 !== a ? "inherit" : "hidden", 0 === e ? "hidden" : "inherit"), s.xs0 = "inherit", r._overwriteProps.push(s.n), r._overwriteProps.push(i)), s
                }
            });
            var Vt = function(t, e) {
            ...
            bt("className", {
                parser: function(t, e, r, s, o, a, l) {
                    var h, u, f, c, p, d = t.getAttribute("class") || "",
                        _ = t.style.cssText;
                    ...
                    return t._gsClassPT = o, o.e = "=" !== e.charAt(1) ? e : d.replace(new RegExp("(?:\\s|^)" + e.substr(2) + "(?![\\w-])"), "") + ("+" === e.charAt(0) ? " " + e.substr(2) : ""), t.setAttribute("class", o.e), h = it(t, u, et(t), l, c), t.setAttribute("class", d), o.data = h.firstMPT, t.style.cssText = _, o = o.xfirst = s.parse(t, h.difs, o, a)
                }
            });
            var Wt = function(t) {
                if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                    ...
                    if ("all" === this.e) o.cssText = "", n = !0;
                        ...
                        for (e = this.e.split(" ").join("").split(","), r = e.length; --r > -1;) i = e[r], l[i] && (l[i].parse === a ? n = !0 : i = "transformOrigin" === i ? At : l[i].p), Vt(o, i);
            ...
            h = o.prototype, h._firstPT = h._lastParsedTransform = h._transform = null, h._onInitTween = function(t, e, a, h) {
                ...
                if (f && "" === O.zIndex && (p = $(t, "zIndex", n), ("auto" === p || "" === p) && this._addLazySet(O, "zIndex", 0)), "string" == typeof e && (y = O.cssText, p = et(t, n), O.cssText = y + ";" + e, p = it(t, p, et(t)).difs, !U && P.test(e) && (p.opacity = parseFloat(RegExp.$1)), e = p, O.cssText = y), e.className ? this._firstPT = _ = l.className.parse(t, e.className, "className", this, null, null, e) : this._firstPT = _ = this.parse(t, e, null), this._transformType) {
                    for (S = 3 === this._transformType, kt ? c && (f = !0, "" === O.zIndex && (T = $(t, "zIndex", n), ("auto" === T || "" === T) && this._addLazySet(O, "zIndex", 0)), d && this._addLazySet(O, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (S ? "visible" : "hidden"))) : O.zoom = 1, v = _; v && v._next;) v = v._next;
                ...
                for (o in e) p = e[o], "function" == typeof p && (p = p(g, m)), a = l[o], a ? i = a.parse(t, p, o, this, i, s, e) : (c = $(t, o, n) + "", v = "string" == typeof p, "color" === o || "fill" === o || "stroke" === o || -1 !== o.indexOf("Color") || v && O.test(p) ? (v || (p = ct(p), p = (p.length > 3 ? "rgba(" : "rgb(") + p.join(",") + ")"), i = xt(x, o, c, p, !0, "transparent", i, 0, s)) : v && D.test(p) ? i = xt(x, o, c, p, !0, null, i, 0, s) : (h = parseFloat(c), d = h || 0 === h ? c.substr((h + "").length) : "", ("" === c || "auto" === c) && ("width" === o || "height" === o ? (h = st(t, o, n), d = "px") : "left" === o || "top" === o ? (h = tt(t, o, n), d = "px") : (h = "opacity" !== o ? 0 : 1, d = "")), y = v && "=" === p.charAt(1), y ? (f = parseInt(p.charAt(0) + "1", 10), p = p.substr(2), f *= parseFloat(p), _ = p.replace(T, "")) : (f = parseFloat(p), _ = v ? p.replace(T, "") : ""), "" === _ && (_ = o in r ? r[o] : d), p = f || 0 === f ? (y ? f + h : f) + _ : e[o], d !== _ && "" !== _ && (f || 0 === f) && h && (h = J(t, o, h, d), "%" === _ ? (h /= J(t, o, 100, "%") / 100, e.strictUnits !== !0 && (c = h + "%")) : "em" === _ || "rem" === _ || "vw" === _ || "vh" === _ ? h /= J(t, o, 1, _) : "px" !== _ && (f = J(t, o, f, _), _ = "px"), y && (f || 0 === f) && (p = f + h + _)), y && (f += h), !h && 0 !== h || !f && 0 !== f ? void 0 !== x[o] && (p || p + "" != "NaN" && null != p) ? (i = new vt(x, o, f || h || 0, 0, i, -1, o, !1, 0, c, p), i.xs0 = "none" !== p || "display" !== o && -1 === o.indexOf("Style") ? p : c) : G("invalid " + o + " tween value: " + e[o]) : (i = new vt(x, o, h, f - h, i, 0, o, u !== !1 && ("px" === _ || "zIndex" === o), 0, c, p), i.xs0 = _))), s && i && !i.plugin && (i.plugin = s);
                return i
            ...
            var Qt = function(t, e, i) {
                ...
                if (t.slice)
                    ...
                    for (r = t.childNodes, n = r.length; --n > -1;) s = r[n], o = s.type, s.style && (e.push(et(s)), i && i.push(s)), 1 !== o && 9 !== o && 11 !== o || !s.childNodes.length || Qt(s, e, i)
            };
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("plugins.CSSRulePlugin", ["plugins.TweenPlugin", "TweenLite", "plugins.CSSPlugin"], function(t, e, i) {
            var r = function() {
                ...
                o = r.prototype = new i;
            return o._propName = "cssRule", o.constructor = r, r.version = "0.6.4", r.API = 2, r.getRule = function(t) {
                var e, i, r, s, o = n.all ? "rules" : "cssRules",
                    a = n.styleSheets,
                    l = a.length,
                    h = ":" === t.charAt(0);
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
            ...
            a = _gsScope._gsDefine.plugin({
                ...
                init: function(t, i, r) {
                    return this._wdw = t === e, this._target = t, this._tween = r, "object" != typeof i ? (i = {
                        ...
                        y: i,
                        x: i
                    }), this.vars = i, this._autoKill = i.autoKill !== !1, this.getX = n(t, "x"), this.getY = n(t, "y"), this.x = this.xPrev = this.getX(), this.y = this.yPrev = this.getY(), null != i.x ? (this._addTween(this, "x", this.x, o(i.x, t, "x") - (i.offsetX || 0), "scrollTo_x", !0), this._overwriteProps.push("scrollTo_x")) : this.skipX = !0, null != i.y ? (this._addTween(this, "y", this.y, o(i.y, t, "y") - (i.offsetY || 0), "scrollTo_y", !0), this._overwriteProps.push("scrollTo_y")) : this.skipY = !0, !0
                },
                set: function(t) {
                    ...
                    this.x < 0 && (this.x = 0), this.y < 0 && (this.y = 0), this._autoKill && (!this.skipX && (o > l || -l > o) && r < i(this._target, "x") && (this.skipX = !0), !this.skipY && (s > l || -l > s) && n < i(this._target, "y") && (this.skipY = !0), this.skipX && this.skipY && (this._tween.kill(), this.vars.onAutoKill && this.vars.onAutoKill.apply(this.vars.onAutoKillScope || this._tween, this.vars.onAutoKillParams || []))), this._wdw ? e.scrollTo(this.skipX ? r : this.x, this.skipY ? n : this.y) : (this.skipY || (this._target.scrollTop = this.y), this.skipX || (this._target.scrollLeft = this.x)), this.xPrev = this.x, this.yPrev = this.y
                }
            }),
            l = a.prototype;
    ...
    ! function(t) {
        ...
        t.fn.animate = function(r, s, l, h) {
            ...
            for (_ in r) {
                if (c = r[_], c instanceof Array && p[c[1]] && (w = w || {}, w[_] = c[1], c = c[0]), "show" === c || "hide" === c || "toggle" === c || -1 !== u.indexOf(_) && -1 !== u.indexOf("," + _ + ",")) return n.call(this, r, s, l, h);
            ...
            return m = function(i) {
                var r, n = a(y);
                if (g)
                    for (r = g.length; --r > -1;) e.to(this, t.fx.off ? 0 : v.duration / 1e3, g[r]);
                n.onComplete = function() {
                    i ? i() : v.old && t(this).each(v.old)
                }, e.to(this, t.fx.off ? 0 : v.duration / 1e3, n)
            }, v.queue !== !1 ? (x.queue(v.queue, m), "function" == typeof v.old && t(x[x.length - 1]).queue(v.queue, function(t) {
                v.old.call(x), t()
            })) : m.call(x), x
        }, t.fn.stop = function(t, i) {
            if (s.call(this, t, i), e) {
                if (i)
                    for (var r, n = e.getTweensOf(this), o = n.length; --o > -1;) r = n[o].totalTime() / n[o].totalDuration(), r > 0 && 1 > r && n[o].seek(n[o].totalDuration());
                e.killTweensOf(this)
            }
            return this
        }, t.gsap = {
        ...
        t.Controller = function(r) {
            var s, o, a = "ScrollMagic.Controller",
                ...
                w = function() {
                    ...
                    v = p.container === window || p.container === document.body || !document.body.contains(p.container), v && (p.container = window), y = P(), p.container.addEventListener("resize", C), p.container.addEventListener("scroll", C), p.refreshInterval = parseInt(p.refreshInterval) || f.refreshInterval, T()
                },
                T = function() {
            ...
            return this.addScene = function(e) {
                ...
                return n.type.Array(e) ? e.forEach(function(t) {
                    c.updateScene(t, i)
                }) : i ? e.update(!0) : _ !== !0 && e instanceof t.Scene && (_ = _ || [], -1 == _.indexOf(e) && _.push(e), _ = R(_), k()), c
        ...
        t.Controller.addOption = function(t, e) {
            ...
            this.on = function(t, e) {
                ...
                return e instanceof t.Controller && o != e && (o && o.removeScene(f), o = e, S(), w(!0), T(!0), x(), o.info("container").addEventListener("resize", b), e.addScene(f), f.trigger("add", {
                    controller: o
                }), f.update()), f
            }, this.enabled = function(t) {
                ...
                if (o)
                    if (t)
                        if (o.enabled() && g) {
                            ...
                            e = c.duration > 0 ? (i - _.start) / (_.end - _.start) : i >= _.start ? 1 : 0, f.trigger("update", {
                                startPos: _.start,
                                endPos: _.end,
                                scrollPos: i
                            }), f.progress(e)
                ...
                if (arguments.length) {
                    var e = !1,
                        ...
                        n = c.reverse || t >= d;
                    if (0 === c.duration ? (e = d != t, d = 1 > t && n ? 0 : 1, p = 0 === d ? a : l) : 0 > t && p !== a && n ? (d = 0, p = a, e = !0) : t >= 0 && 1 > t && n ? (d = t, p = l, e = !0) : t >= 1 && p !== h ? (d = 1, p = h, e = !0) : p !== l || n || R(), e) {
                        var s = {
                                progress: d,
                                state: p,
                                scrollDirection: r
            ...
            var x = function() {
                    _ = {
                        start: m + c.offset
                    }, o && c.triggerElement && (_.start -= o.info("size") * c.triggerHook), _.end = _.start + c.duration
                },
                w = function(t) {
                    if (s) {
                        var e = "duration";
                ...
                k = function(t) {
                    f[t] || (f[t] = function(e) {
                        return arguments.length ? ("duration" === t && (s = void 0), O(t, e) && (f.trigger("change", {
                            what: t,
                            newval: c[t]
            ...
            var R = function(t) {
                    if (C && o) {
                        ...
                        if (t || p !== l) {
                            ...
                            A.pushFollowers ? c.duration > 0 && (p === h && 0 === parseFloat(n.css(A.spacer, "padding-top")) ? s = !0 : p === a && 0 === parseFloat(n.css(A.spacer, "padding-bottom")) && (s = !0)) : r[e.vertical ? "top" : "left"] = c.duration * d, n.css(i, r), s && M()
                        } else {
                            ...
                            u[e.vertical ? "top" : "left"] += f, n.css(A.spacer.firstChild, {
                                top: u.top,
                                left: u.left
                            })
                        }
                ...
                M = function() {
                    if (C && o && A.inFlow) {
                        ...
                        A.relSize.width || A.relSize.autoFullWidth ? t ? n.css(C, {
                            ...
                            width: "100%"
                        }) : (s["min-width"] = n.get.width(e ? C : i, !0, !0), s.width = t ? s["min-width"] : "auto"), A.relSize.height ? t ? n.css(C, {
                            height: n.get.height(A.spacer) - (A.pushFollowers ? c.duration : 0)
                        }) : n.css(C, {
                            height: "100%"
                        }) : (s["min-height"] = n.get.height(e ? i : C, !0, !r), s.height = t ? s["min-height"] : "auto"), A.pushFollowers && (s["padding" + (e ? "Top" : "Left")] = c.duration * d, s["padding" + (e ? "Bottom" : "Right")] = c.duration * (1 - d)), n.css(A.spacer, s)
                    }
                },
                F = function() {
            ...
            this.setPin = function(t, i) {
                ...
                if (a || n.extend(c, n.css(C, ["width", "height"])), n.css(u, c), u.setAttribute(e, ""), n.addClass(u, i.spacerClass), A = {
                        spacer: u,
                        relSize: {
                ...
                }), window.addEventListener("scroll", F), window.addEventListener("resize", F), window.addEventListener("resize", L), C.addEventListener("mousewheel", z), C.addEventListener("DOMMouseScroll", z), R(), f
                ...
                if (C) {
                    ...
                    window.removeEventListener("scroll", F), window.removeEventListener("resize", F), window.removeEventListener("resize", L), C.removeEventListener("mousewheel", z), C.removeEventListener("DOMMouseScroll", z), C = void 0
                }
                return f
            };
            var D, E = [];
            return f.on("destroy.internal", function(t) {
                ...
                return 0 !== i.length && n.type.String(e) ? (E.length > 0 && f.removeClassToggle(), D = e, E = i, f.on("enter.internal_class leave.internal_class", function(t) {
                ...
                return t && E.forEach(function(t) {
                    n.removeClass(t, D)
                }), f.off("start.internal_class end.internal_class"), D = void 0, E = [], f
            }, v(), f
        };
        var r = {
            defaults: {
        ...
        if ($(window).load(function() {
                $(".splashscreen").addClass("splashscreen--is-hidden"), setTimeout(function() {
                    $(".splashscreen").css({
                        display: "none"
                    });
                ...
                e.preventDefault(), $(".navigation__container").hasClass("navigation__container--is-open") && t();
        ...
        $(".work__navigation-el").click(function() {
            ...
            t.parent().children().removeClass("work__navigation-el--is-active"), t.addClass("work__navigation-el--is-active"), $(".work__list").children().removeClass("work__list-el--is-active"), $(".work__list").children().eq(e).addClass("work__list-el--is-active")
        })
    });